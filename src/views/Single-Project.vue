  ...
  <main class="app-main">
    <header>
      ...
      <section class="project__info">
        <p>
          <svg xmlns="http://www.w3.org/2000/svg" width="1.2rem" height="1.2rem" fill="currentColor" class="bi bi-calendar" viewBox="0 0 16 16">
        ...
        <a v-if="project?.link" :href="project?.link" target="_blank">
            <svg xmlns="http://www.w3.org/2000/svg" width="1.2rem" height="1.2rem" fill="currentColor" viewBox="0 0 640 512">
    ...
    <section class="project-img">
      ...
      <section class="project-img__img">
        <img v-for="(image, key) in project?.image" :key="key" :src="(`/src/assets/img/projets/${image.src}`)" :alt="image.alt"/>
      </section>
    </section>
